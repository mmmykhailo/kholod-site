...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product categories with nested support';
  ...
  attributes: {
    childrenCategories: Schema.Attribute.Relation<
      'oneToMany',
    ...
    specificationFilters: Schema.Attribute.Component<
      'shared.specification-filter',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGeneralSiteInfoGeneralSiteInfo
  extends Struct.SingleTypeSchema {
  collectionName: 'general_site_infos';
  info: {
    displayName: 'General site info';
    pluralName: 'general-site-infos';
    singularName: 'general-site-info';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    contactPhoneNumbers: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general-site-info.general-site-info'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Products with category support';
    displayName: 'Product';
    pluralName: 'products';
