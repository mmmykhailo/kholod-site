...
export default function OrderDialog({
  ...
  const fetcher = useFetcher<ActionData>({ key: `order-${formKey}` });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Замовити товар</DialogTitle>
          <DialogDescription>
            Залиште свої контактні дані, і ми зв'яжемося з вами для оформлення
            замовлення
          </DialogDescription>
        </DialogHeader>
